    ...
    <div className="about-container">
      ...
      <footer className="about-footer">
        <div className="footer-icons">
          ...
          <a href="https://www.tiktok.com/@estehnyanusantara?_t=8elWXFoR2t5&_r=1" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer-contact">
          <p><FontAwesomeIcon icon={faEnvelope} /> Email: info@nusantarabrew.com</p>
          <p><FontAwesomeIcon icon={faPhone} /> Telepon: +62 812-3456-7890</p>
        </div>
      </footer>
    </div>
  );
